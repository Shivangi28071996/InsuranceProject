...
public class CustomerInfo {
	...
	private ArrayList<CustomerInsurance> customerInsurance;
	...
	public CustomerInfo(String customerId, String customerName, String gender, long phone, long mobileNo, String dob,
			...
			ArrayList<CustomerInsurance> customerInsurance) {
		super();
	...
	public ArrayList<CustomerInsurance> getCustomerInsurance() {
		return customerInsurance;
	}
	public void setCustomerInsurance(ArrayList<CustomerInsurance> customerInsurance) {
		this.customerInsurance = customerInsurance;
	}
